...
public class IconsHelper {
  public const string Charities = "far fa-hands-usd";
  public const string ChevronDown = "far fa-chevron-down";
  public const string ChevronUp = "far fa-chevron-up";
  public const string Dashboard = "far fa-tachometer-alt-fast";
  public const string DirectDebit = "far fa-university";
  public const string Donors = "far fa-donate";
